...
contextBridge.exposeInMainWorld('api', {
    ...
    getBaseDir: () => ipcRenderer.invoke('get-basedir'),
                                ...
                                customRunOptions: (installerGameId) => ipcRenderer.invoke('custom-run-options', installerGameId),
                                ...
                                customSetRunOptions: (payload) => ipcRenderer.invoke('custom-set-run-options', payload),
                                onSoundtrackBuildProgress: (cb) => ipcRenderer.on('soundtrack-build-progress', (e, d) => cb(d)),
